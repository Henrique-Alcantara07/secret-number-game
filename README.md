...
Um jogo simples de adivinhação onde o usuário precisa descobrir um número secreto sorteado entre 1 e 10, recebendo dicas se o número informado é maior ou menor que o número correto. O jogo também conta com narração por voz utilizando a Web Speech API.
...
Sorteio aleatório de um número secreto entre 1 e 10 (sem repetição até todos os números terem sido sorteados)
...
Digite um número entre 1 e 10 no campo de input
